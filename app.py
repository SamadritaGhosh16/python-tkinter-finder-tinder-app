...
class Login:
    ...
    def __init__(self):
        ...
        self.root.configure(background="#6D2483")
    ...
    def load_gui(self):
       ...
       self.label1=Label(self.root,text="Finder",fg="white",bg="#6D2483")
       self.label1.configure(font=("Times",30,"bold"))
       self.label1.pack(pady=(10,10))

       self.label2=Label(self.root,text="Email",fg="white",bg="#6D2483")
       ...
       self.label3=Label(self.root,text="Password",fg="white",bg="#6D2483")
       ...
       self.login.pack(pady=(5,10),ipadx=65,ipady=3)


       self.label4=Label(self.root,text="Not a member? Sign up", fg="white", bg="#6D2483")
    ...
    def register_gui(self):
        ...
        self.label0 = Label(self.root, text="Finder", fg="white", bg="#6D2483")
        self.label0.configure(font=("Times", 30, "bold"))
        self.label0.pack(pady=(10, 10))

        self.label1 = Label(self.root, text="Name", fg="white", bg="#6D2483")
        ...
        self.filebtn=Button(self.root, text="Upload Profile Pic", command= lambda: self.upload_file())
        ...
        self.register.pack(pady=(5, 10), ipadx=65, ipady=3)

        self.label4 = Label(self.root, text="Already a member? Login", fg="white", bg="#6D2483")
        self.label4.configure(font=("Times", 20, "italic"))
        self.label4.pack(pady=(5, 5))
    ...
    def main_window(self,data, mode=1, index=None, num=None):
        ...
        self.label1=Label(self.root,text="Name:"+data[1],fg="white",bg="#6D2483")
        self.label1.configure(font=("Times",15,"bold"))
        self.label1.pack(pady=(10,10))


        if len(data[7])!=0:
            self.label2 = Label(self.root, text="From:"+data[7], fg="white", bg="#6D2483")
            self.label2.configure(font=("Times", 15, "bold"))
            self.label2.pack(pady=(10,10))

        if len(data[6])!= 0:
            self.label3 = Label(self.root, text="Not interested in:"+data[6], fg="white", bg="#6D2483")
            self.label3.configure(font=("Times", 15, "bold"))
            self.label3.pack(pady=(10,10))

        if len(data[4])!= 0:
            self.label4 = Label(self.root, text="About me:"+data[4], fg="white", bg="#6D2483")
    ...
    def propose(self,romeo_id,juliet_id):
        ...
        if response==1:
            messagebox.showinfo("Success","Proposal sent succesfully.Fingers crossed!")
        elif response==-1:
    ...
    def edit_profile(self):
        ...
        self.label0 = Label(self.root, text="Edit Profile", fg="white", bg="#6D2483")
        self.label0.configure(font=("Times", 30, "bold"))
        self.label0.pack(pady=(10, 10))

        self.label1 = Label(self.root, text="Bio:", fg="white", bg="#6D2483")
        ...
        self.label2 = Label(self.root, text="Age:", fg="white", bg="#6D2483")
        ...
        self.label3 = Label(self.root, text="Gender:", fg="white", bg="#6D2483")
        ...
        self.label4 = Label(self.root, text="City:", fg="white", bg="#6D2483")
